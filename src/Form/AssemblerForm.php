...
class AssemblerForm extends FormBase {
   ...
   * The form helper.
   *
   * @var \Drupal\vardoc\AssemblerFormHelper
   */
   ...
   * @param \Drupal\vardoc\Form\FormHelper $form_helper
   *   The form helper.
   */
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('vardoc.form_helper')
    );
  }
      ...
      foreach ($extraFeatures as $extra_feature_key => $extra_feature_info) {
        ...
        if (isset($extra_feature_info['config_form']) &&
          ...
          if (isset($extra_feature_info['formbit'])) {
            $formbit_file_name = \Drupal::service('extension.list.profile')->getPath('vardoc') . '/' . $extra_feature_info['formbit'];
      ...
      foreach ($demoContent as $demo_content_key => $demo_content_info) {
        ...
        if (isset($demo_content_info['config_form']) &&
          ...
          if (isset($demo_content_info['formbit'])) {
            $formbit_file_name = \Drupal::service('extension.list.profile')->getPath('vardoc') . '/' . $demo_content_info['formbit'];
            if (file_exists($formbit_file_name)) {
      ...
      foreach ($extraFeatures as $extra_feature_key => $extra_feature_info) {
        ...
        if (isset($extra_feature_info['config_form']) &&
          ...
          if (file_exists($formbit_file_name)) {
            ...
            $GLOBALS['install_state']['vardoc']['extra_features_configs'] = $extra_features_editable_configs;
          }
        }
      }

      $GLOBALS['install_state']['vardoc']['extra_features_values'] = $extra_features_values;
    }
      ...
      foreach ($demoContent as $demo_content_key => $demo_content_info) {
        ...
        if (isset($demo_content_info['config_form']) &&
          ...
          if (file_exists($formbit_file_name)) {
            ...
            $GLOBALS['install_state']['vardoc']['demo_content_configs'] = $demo_content_editable_configs;
          }
        }
      }

      $GLOBALS['install_state']['vardoc']['demo_content_values'] = $demo_content_values;
    }
  }
