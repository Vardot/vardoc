...
# Super admin: { email: 'test.super_admin@vardot.com', password: 'dD.123123ddd' }
  ...
  Scenario: Create the Normal user user.
     ...
     When I fill in "test authenticated" for "First name"
      ...
      And I fill in "test.authenticated@vardot.com" for "Email address"
  ...
  Scenario: Create the Editor user.
     ...
     When I fill in "test editor" for "First name"
      ...
      And I fill in "test.editor@vardot.com" for "Email address"
  ...
  Scenario: Create the Content admin user.
     ...
     When I fill in "test admin" for "First name"
      ...
      And I fill in "test.content_admin@vardot.com" for "Email address"
  ...
  Scenario: Create the SEO admin user.
     ...
     When I fill in "test seo admin" for "First name"
      ...
      And I fill in "test.seo_admin@vardot.com" for "Email address"
  ...
  Scenario: Create the Site admin user.
     ...
     When I fill in "test site admin" for "First name"
      ...
      And I fill in "test.site_admin@vardot.com" for "Email address"
  ...
  Scenario: Create the Super admin user.
     ...
     When I fill in "test super admin" for "First name"
      ...
      And I fill in "test.super_admin@vardot.com" for "Email address"
